    ...
    return(
        <section className='about' id='project'>
            <div className='about__container'>
                <h2 className='title title-container'>О проекте</h2>
                ...
                <div className='about__time'>
                    <p className='about__time-text about__time-container'>1 неделя</p>
                    <p className='about__time-text'>4 неделя</p>
                    <p className='about__time-end'>Back-end</p>
                    <p className='about__time-end'>Front-end</p>
                </div>
            </div>
        </section>
    );  
